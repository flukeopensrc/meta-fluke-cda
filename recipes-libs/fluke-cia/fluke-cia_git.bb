...
HOMEPAGE = "https://github.com/FlukeCorp-emu/cia-sw-src"
SECTION = "libs"
LICENSE = "Proprietary"
...
SRC_URI = "git://git@ssh.github.com/FlukeCorp-emu/cia-sw-src.git;protocol=ssh;branch=develop;destsuffix=git/cia/src;name=ciasrc \
	...
	git://github.com/flukeopensrc/cia-sw-thirdparty.git;protocol=git;branch=develop;destsuffix=git/cia/thirdparty;name=ciathirdparty \
