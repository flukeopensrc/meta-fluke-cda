...
export IMAGE_BASENAME = "fluke-cda-blackhawk-image"

IMAGE_FSTYPES = " ubi"
IMAGE_FSTYPES += " jffs2"
UBI_VOLNAME = "root-fs"

fluke_cda_blackhawk_image_postprocess_common() {
...
IMAGE_PREPROCESS_COMMAND_append = " fluke_cda_blackhawk_image_postprocess_common; "
